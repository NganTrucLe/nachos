...
{ 
    ...
    // while Nachos is running.
        ...
        freeMapFile = new OpenFile(NULL,FreeMapSector);
        directoryFile = new OpenFile(NULL,DirectorySector);
...
{ 
    ...
    if (sector >= 0) 		
	openFile = new OpenFile(name,sector);	// name was found in directory 
    delete directory;
...
OpenFile* FileSystem::Open(char *name, int type)
{
	...
	sector = directory->Find(name);
	if (sector >= 0)
		openf[freeSlot] = new OpenFile(name ,sector, type);	// name was found in directory 
	delete directory;
...
bool FileSystem::isExist(char *name)
{
	...
	sector = directory->Find(name);
	if (sector >= 0)
		return TRUE;	// name was found in directory 
	delete directory;
	return FALSE;			
}
//----------------------------------------------------------------------
